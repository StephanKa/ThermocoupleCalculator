...
struct TypeR
{
    struct [[maybe_unused]] TemperatureToVoltage
    {
        ...
        struct Negative
        {
            ...
            static constexpr std::array<double, 10> coefficient = {0.000000000000E+00,
                                                                   0.528961729765E-02,
                                                                   0.139166589782E-04,
                                                                   -0.238855693017E-07,
                                                                   0.356916001063E-10,
    ...
    struct [[maybe_unused]] VoltageToTemperature
    {
        struct Negative
        {
            ...
            static constexpr std::array<double, 11> coefficient = {0.0000000E+00,
                                                                   1.8891380E+02,
                                                                   -9.3835290E+01,
                                                                   1.3068619E+02,
                                                                   -2.2703580E+02,
        ...
        struct Positive
        {
            ...
            static constexpr std::array<double, 11> coefficient = {1.334584505E+01,
                                                                   1.472644573E+02,
                                                                   -1.844024844E+01,
                                                                   4.031129726E+00,
                                                                   -6.249428360E-01,
