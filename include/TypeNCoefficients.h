...
struct TypeN
{
    struct [[maybe_unused]] TemperatureToVoltage
    {
        struct Positive
        {
            ...
            static constexpr double upperLimit = 1300.0;
            static constexpr std::array<double, 11> coefficient = {0.000000000000E+00, 0.259293946010E-01, 0.157101418800E-04, 0.438256272370E-07,
                -0.252611697940E-09, 0.643118193390E-12, -0.100634715190E-14, 0.997453389920E-18, -0.608632456070E-21, 0.208492293390E-24, -0.306821961510E-28};
        };
    ...
    struct [[maybe_unused]] VoltageToTemperature
    {
        struct Negative
        {
            static constexpr double lowerLimit = -3.99;
            static constexpr double upperLimit = 0.0;
            static constexpr double range = 0.03;
            static constexpr double error = -0.02;
            static constexpr std::array<double, 10> coefficient = {0.0000000E+00, 3.8436847E+01, 1.1010485E+00, 5.2229312E+00, 7.2060525E+00, 5.8488586E+00,
                2.7754916E+00, 7.7075166E-01, 1.1582665E-01, 7.3138868E-03};
        };

        struct Positive
        {
            static constexpr double lowerLimit = 0.0;
            static constexpr double upperLimit = 20.613;
            static constexpr double range = 0.03;
            static constexpr double error = -0.02;
