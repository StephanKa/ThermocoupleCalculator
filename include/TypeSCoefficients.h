...
struct TypeS
{
    ...
    struct [[maybe_unused]] TemperatureToVoltage
    {
        struct Positive
        {
            ...
            static constexpr std::array<double, 5> coefficient = {0.132900444085E+01, 0.334509311344E-02, 0.654805192818E-05, -0.164856259209E-08, 0.129989605174E-13};
        };
    ...
    struct [[maybe_unused]] VoltageToTemperature
    {
        ...
        struct Positive
        {
            ...
            static constexpr std::array<double, 10> coefficient = {1.291507177E+01,
                                                                   1.466298863E+02,
                                                                   -1.534713402E+01,
                                                                   3.145945973E+00,
                                                                   -4.163257839E-01,
